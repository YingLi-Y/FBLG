...
def read_option():
    ...
    parser.add_argument('--dist', help='type of distribution;', type=int, default=4)
    parser.add_argument('--skew', help='the degree of niid;', type=float, default=0.79)
    parser.add_argument('--num_clients', help='the number of clients;', type=int, default=20)
